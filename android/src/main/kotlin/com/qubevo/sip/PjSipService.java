...
import com.qubevo.sip.dto.CallSettingsDTO;
import com.qubevo.sip.dto.ServiceConfigurationDTO;
import com.qubevo.sip.dto.SipMessageDTO;
import com.qubevo.sip.utils.ArgumentUtils;
            ...
            job(new Runnable() {
                ...
                public void run() {
                    ...
                    if (mIncallWakeLock == null) {
                        mIncallWakeLock = mPowerManager.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "sip:incall");
                    }
